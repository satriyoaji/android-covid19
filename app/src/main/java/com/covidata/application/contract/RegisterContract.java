...
public interface RegisterContract {
    ...
    interface Presenter {
        void register(FirebaseFirestore db, String name, String email, String password, String confirmPassword);
        String bcryptPassword(String password);
    }

    interface Interactor {
        void requestRegister(FirebaseFirestore db, String name, String email, String password, String confirmPassword, RequestCallback<RegisterResponse> requestCallback);
